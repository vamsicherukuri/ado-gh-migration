...
🎛️ **Input Parameters:**
- Reads: `config.scripts.inventory.adoOrg` ADO organization name from `migration-config.json`
...
🎛️ **Input Parameters:**
- `AdoOrganization`, `AdoTeamProject`, `AdoRepository`, `GitHubOrganization`, `GitHubRepository` read from the state file generated by `2_migrate_repo.ps1`
...
🎛️ **Input Parameters:**
- The script reads the value of `config.scripts.generateMannequins.outputCSV` from `migration-config.json`
- That value is the CSV file path (like `mannequins.csv`)
- Also reads: `config.githubOrganization` → GitHub organization name from `migration-config.json`
...
🎛️ **Input Parameters:**
- The script reads the value of `config.scripts.reclaimMannequins.inputCSV` from `migration-config.json`
- That value is the CSV file path (like `mannequins.csv`)
- Also reads: `config.githubOrganization` → GitHub organization name
